...
- **النقشة:** `assets/images/pattern.png` — نجمة ثمانية هندسية (زخرفة عمانية/إسلامية) مرسومة لتتكرر بلا حدود.
  تُستعمل عبر `PatternOverlay` بشفافية 6–8٪ فوق الأسطح الكحلية، و22٪ بلون القسم فوق أغلفة البطاقات الفاتحة.
