...
## مناطق الحملة (§19) — البنية أربعٌ والخريطة واحدة

§19 تطلب أربع مناطق بأربعين مرحلة، وتقول صراحةً: «**لا يلزم صنع الفن
النهائي لكل الأربع في أول Vertical Slice، لكن يجب أن تدعم البنية ذلك**».

**فالبنية تحملها كلّها**: أربعة أصول `ZoneDefinition` وأربعون
`StageDefinition`، ولكل منطقةٍ معاملاتُ بيئةٍ تعمل فعلاً (الأرض والمدى
والنور والتهديد). **والخريطة المبنيّة واحدة** — تضاريس تخوم الجمر.

| الناقص | ما يلزمه |
|---|---|
| تضاريس مستنقع الأجراس | طبقةُ وحلٍ مرسومة وبرك سمّ ثابتة |
| تضاريس امتداد الجليد | طبقةُ جليدٍ وثلج، ومؤثّر عاصفةٍ يقصّر المدى بصريّاً |
| تضاريس كسوف الرماد | سماءُ كسوفٍ وإضاءةٌ أخفض بكثير |
| ثلاثون تخطيطَ عقدٍ ومسار | اليوم: تخطيطٌ واحدٌ يُعاد لكل مرحلة |

وكلّها تُبنى من `DawnkeepWorldSceneBuilder` و`DrawnMaterials` نفسيهما كما
بُنيت الأولى — **لا أصل يُؤخذ من لعبةٍ أخرى ولا من الصور المرجعية**
(قاعدة المشروع أعلاه).
