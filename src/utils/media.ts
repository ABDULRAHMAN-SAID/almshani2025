...
export const MEDIA_LIMITS: Record<MediaKind, MediaLimit> = {
  // ستّة لا ثلاثة: صورة من كاميرا هاتف حديث تتجاوز الثلاثة حتى بعد الضغط،
  // فكان التطبيق يرفض صورة عاديّة التقطها صاحبها للتوّ ويطلب منه «أصغر» بلا
  // أن يملك وسيلة لتصغيرها. والستّة تسع ما تنتجه الكاميرات المعتادة.
  image: { bytes: 6 * 1024 * 1024, label: "٦ ميجابايت" },
