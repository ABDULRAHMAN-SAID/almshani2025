 ...
 *
 * ثم تُضغط المروحة أفقيًّا (scaleX): الطائرة تُرى من جانبها، وقرصُ المروحة
 * في هذا المنظر يُرى من حرفه — شريطًا رأسيًّا ضيّقًا، لا دائرةً كاملة كأنّها
 * مقابلةٌ للناظر. والدوران قبل الضغط في ترتيب التحويلات، فتُدار الشفرات ثم
 * يُسطَّح ما دارت فيه — وهذا هو ما تراه العين من مروحةٍ تدور من الجانب.
 *
...
/** عرضُ قرص المروحة من الجانب نسبةً إلى قطره — قيست من الرسم الأصلي. */
const EDGE_ON = 0.23;
