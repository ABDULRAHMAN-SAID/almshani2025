    ...
    public static class DawnkeepEquipmentSetup
    {
        ...
        public static void Setup()
        {
            ...
            all.Add(Weapon("Gear_DawnBow", "قوس الفجر", "Dawn Bow",
                ...
                range: 4.8f, interval: 0.65f, shape: 1f, gold: 100, essence: 6,
                start: true,
            ...
            all.Add(Weapon("Gear_Sunblade", "نصل الشمس", "Sunblade",
                ...
                range: 1.6f, interval: 0.55f, shape: 80f, gold: 180, essence: 10,
                start: false,
            ...
            all.Add(Weapon("Gear_StormStaff", "عصا العاصفة", "Storm Staff",
                ...
                range: 4.2f, interval: 0.90f, shape: 0.5f, gold: 260, essence: 16,
                start: false,
            ...
            all.Add(Weapon("Gear_HandBallista", "باليستا اليد", "Hand Ballista",
                ...
                range: 6.4f, interval: 1.35f, shape: 1.4f, gold: 280, essence: 18,
                start: false,
            ...
            all.Add(Weapon("Gear_EmberAxe", "فأس الجمر", "Ember Axe",
                ...
                range: 1.8f, interval: 1.05f, shape: 3.6f, gold: 340, essence: 24,
                start: false,
            ...
            all.Add(Weapon("Gear_EngineerGauntlet", "قفّاز المهندس", "Engineer Gauntlet",
                ...
                range: 3.0f, interval: 0.70f, shape: 1.33f, gold: 320, essence: 22,
                start: false,
            ...
            all.Add(Gear("Mount_Courser", "الجواد الطليق", "Courser",
                ...
                EquipmentSlot.Mount, Rarity.Common, gold: 120, essence: 8, start: true,
            ...
            all.Add(Gear("Mount_ArmoredBoar", "الخنزير المدرَّع", "Armored Boar",
                ...
                EquipmentSlot.Mount, Rarity.Uncommon, gold: 200, essence: 12, start: false,
            ...
            all.Add(Gear("Mount_DawnBeetle", "خنفساء الفجر", "Dawn Beetle",
                ...
                EquipmentSlot.Mount, Rarity.Rare, gold: 280, essence: 18, start: false,
            ...
            all.Add(Gear("Mount_WindStag", "أيّل الريح", "Wind Stag",
                ...
                EquipmentSlot.Mount, Rarity.Epic, gold: 360, essence: 26, start: false,
            ...
            all.Add(Gear("Relic_LanternHeart", "قلب القنديل", "Lantern Heart",
                ...
                EquipmentSlot.Relic, Rarity.Rare, gold: 240, essence: 16, start: false,
            ...
            all.Add(Gear("Relic_BrokenSundial", "المزولة المكسورة", "Broken Sundial",
                ...
                EquipmentSlot.Relic, Rarity.Epic, gold: 320, essence: 22, start: false,
            ...
            all.Add(Gear("Relic_MasonsOath", "عهد البنّاء", "Mason's Oath",
                ...
                EquipmentSlot.Relic, Rarity.Uncommon, gold: 180, essence: 10, start: false,
            ...
            all.Add(Gear("Relic_AshMirror", "مرآة الرماد", "Ash Mirror",
                ...
                EquipmentSlot.Relic, Rarity.Epic, gold: 330, essence: 23, start: false,
            ...
            all.Add(Gear("Relic_QuarryStone", "حجر المحجر", "Quarry Stone",
                ...
                EquipmentSlot.Relic, Rarity.Common, gold: 120, essence: 6, start: true,
            ...
            all.Add(Gear("Relic_LongSight", "بُعد النظر", "Long Sight",
                ...
                EquipmentSlot.Relic, Rarity.Rare, gold: 250, essence: 17, start: false,
            ...
            all.Add(Gear("Relic_RallyHorn", "بوق الحشد", "Rally Horn",
                ...
                EquipmentSlot.Relic, Rarity.Uncommon, gold: 190, essence: 11, start: false,
            ...
            all.Add(Gear("Relic_DuelistsMark", "وسم المبارز", "Duelist's Mark",
                ...
                EquipmentSlot.Relic, Rarity.Legendary, gold: 480, essence: 40, start: false,
            ...
            all.Add(Gear("Relic_DawnLedger", "دفتر الفجر", "Dawn Ledger",
                ...
                EquipmentSlot.Relic, Rarity.Legendary, gold: 460, essence: 38, start: false,
            ...
            all.Add(Gear("Armor_Padded", "درعٌ مبطَّن", "Padded Coat",
                ...
                EquipmentSlot.Armor, Rarity.Common, gold: 100, essence: 6, start: true,
            ...
            all.Add(Gear("Armor_Scale", "درعٌ حَرشفيّ", "Scale Mail",
                ...
                EquipmentSlot.Armor, Rarity.Uncommon, gold: 190, essence: 11, start: false,
            ...
            all.Add(Gear("Armor_Dawnplate", "صفيحة الفجر", "Dawnplate",
                ...
                EquipmentSlot.Armor, Rarity.Rare, gold: 270, essence: 18, start: false,
            ...
            all.Add(Gear("Armor_Shadowweave", "نسيج الظلّ", "Shadowweave",
                ...
                EquipmentSlot.Armor, Rarity.Epic, gold: 340, essence: 24, start: false,
            ...
            all.Add(Gear("Armor_Bulwark", "حِصنُ الصدر", "Bulwark Harness",
                ...
                EquipmentSlot.Armor, Rarity.Epic, gold: 350, essence: 25, start: false,
            ...
            all.Add(Gear("Armor_FirstLight", "أوّل الضوء", "First Light",
                ...
                EquipmentSlot.Armor, Rarity.Legendary, gold: 470, essence: 39, start: false,
            ...
            BoonDefinition.Change? b = null, BoonDefinition.Change? c = null)
        {
            ...
            SetPrivate(def, "essenceCost", essence);
