-- ============================================================================
-- الصقة واحدة: بنية القاعدة ومحتوى البداية معًا
-- ============================================================================
--
-- هذا الملفّ ليس جديدًا: هو schema.sql ثم starter-content.sql ملصوقين على
-- الترتيب، لمن يبني قاعدته من المتصفّح بلا سطر أوامر. خطوة واحدة بدل اثنتين،
-- ولا فرصة لتنفيذ المحتوى قبل الجداول التي يسكنها.
--
-- الاستعمال:
--   1. افتح مشروعك في supabase.com
--   2. من القائمة الجانبية: SQL Editor ← New query
--   3. الصق هذا الملفّ كلّه واضغط Run
--
-- وتنفيذه مرّتين لا يضرّ: كل ما فيه مكتوب ليُعاد بلا خطأ.
--
-- ولا تحرّر هذا الملفّ — حرّر الأصلين، فهو يُولَّد منهما.
-- ============================================================================
